...
function control_picom(opt)
    ...
    -- picom_pid = ""
    -- ash("pgrep picom | save /tmp/awesome_picom_pid.txt", function()
    --     ash("open /tmp/awesome_picom_pid.txt", function(out) picom_pid = out end)
    -- end)
    -- if picom_pid ~= "" and opt ~= "kill" then
    --     cmd = kill .. " ; " .. cmd
    -- end
